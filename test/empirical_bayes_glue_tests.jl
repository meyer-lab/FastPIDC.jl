...
if FastPIDC.EB_EXISTS
    ...
    reference_priors = Dict([(("bbb", "aaa"), 1), (("ccc", "aaa"), 0), (("ccc", "bbb"), 1)])
    @test make_priors(prior_path) == reference_priors
    reference_priors = Dict([(("ccc", "aaa"), 0), (("ccc", "bbb"), 1), (("bbb", "aaa"), 0)])
    @test make_priors(prior_path, 1.0, 2) == reference_priors
    reference_priors = Dict([(("bbb", "aaa"), 2), (("ccc", "aaa"), 0), (("ccc", "bbb"), 2)])
    ...
    reference_priors = Dict([(("ccc", "aaa"), 0), (("ccc", "bbb"), 2), (("bbb", "aaa"), 0)])
    ...
    ref_weights =
        empirical_bayes(benchmark_stats, benchmark_priors, 5, :Gamma, tail = :two, w0 = 2.2)
    ...
    ref_no_prior_weights =
        empirical_bayes(benchmark_stats, 5, :Gamma, tail = :two, w0 = 2.2)
